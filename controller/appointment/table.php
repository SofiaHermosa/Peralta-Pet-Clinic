<?php
    ...
    foreach($appointments as $appointment){
        ...
        if($appointment['status'] == 2){
             ...
             $button='<center><a data-apt="'.$json.'" href="javascript:void(0)" class="text-white rounded py-2 px-4 bg-yellow-600 hover:bg-yellow-500 aptUpdtStatus" data-status="3">Decline</a></center>'; 
        }
