			...
			<div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10 md:gap-20 py-20 flex justify-center">
				<div data-aos="zoom-in" data-aos-duration="1000" class="w-full animate-svg mt-10 md:mt-0 bg-white rounded-sm shadow-lg transition transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
					...
					<div class="transform -translate-y-12 top-14 w-full px-6 py-6 h-auto overflow-hidden">
						<h1 class="w-full text-lg text-center font-semibold text-gray-900">Lorem ipsum</h1>
				...
				<div data-aos="zoom-in" data-aos-duration="1000" class="w-full animate-svg mt-10 md:mt-0 bg-white rounded-sm shadow-lg transition transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
					...
					<div class="transform -translate-y-12 top-14 w-full px-6 py-6 h-auto overflow-hidden">
						<h1 class="w-full text-lg font-semibold text-gray-900 text-center">Lorem ipsum</h1>
						<p class="w-full py-4 px-2 text-sm font-semibold text-gray-800 text-center">
							It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
						</p>	
					</div>
