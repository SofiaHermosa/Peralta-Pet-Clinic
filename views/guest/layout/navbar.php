<a href="#banner" class="nav--link fixed right-4 bottom-6 rounded-md p-2 text-indigo-600 font-extrabold bg-gray-400 shadow-9xl text-lg goTopBtn mix-blend-luminosity ring-2 ring-inset focus:ring-black">
    ...
    <div class="ml-3 justify-self-end hidden lg:block flex-grow">
      <div>
        <button type="button" class="max-w-xs float-right bg-blue-700 rounded-full flex items-center text-sm toggle-menu" data-toggle="#userMenuDesktop" aria-expanded="false" aria-haspopup="true">
          ...
          <img class="h-8 w-8 rounded-full" src="../../../assets/images/default-user.jpg" alt="">
        </button>
      </div>
...
<div class="fixed inset-x-0 p-2 transform origin-top-right hidden z-50" id="guestMobileNav">
  <div class="rounded-lg shadow-md bg-black backdrop-filter backdrop-blur-md bg-opacity-40 ring-1 ring-black ring-opacity-5 overflow-hidden">
    ...
    <div class="nav px-2 pt-2 pb-3 space-y-1">
      ...
      <a href="#services" class="nav--link block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-gray-50">Services</a>

      <a href="#ourTeam" class="nav--link block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-gray-50">Our Teams</a>

      <a href="#about" class="nav--link block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-gray-50">About Us</a>
      
      <a href="#contactUs" class="nav--link block px-3 py-2 rounded-md text-base font-medium text-white hover:text-gray-200 hover:bg-gray-50">Contact Us</a>
