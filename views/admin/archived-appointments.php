          ...
          <table id="datatable" cellspaing="5" class="w-full divide-y divide-gray-200">
            <thead>
              <tr>
                ...
                <th scope="col" width="20%" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  Decline Reason
                </th>
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
...
<script>
  window.url='/res/table/appointment?status=<?php echo $status ?? null ?>&type=0';
